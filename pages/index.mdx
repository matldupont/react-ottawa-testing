...
<Steps>
  ...
  <Step><p>New project, new requirements</p></Step>
  <Step><p>New feature, new package versions</p></Step>
...
<Steps>  
  <Step><p>I boils down to JS modules with everything required to run</p></Step>
