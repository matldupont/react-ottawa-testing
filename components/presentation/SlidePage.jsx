...
export default function SlidePage({ children, next }) {
  ...
  const renderSlide = () => {
    ...
    return (
      <Slide>
        <Pane>{generatedSlides[currentSlide]}</Pane>
      </Slide>
    )
  }
  ...
  return (
    <Swipeable onSwipedLeft={swipeLeft} onSwipedRight={swipeRight}>
      ...
      <div className="absolute bottom-10 right-10 text-sm">
        <span
          onClick={swipeRight}
          className="text-normal cursor-pointer text-neutral-500 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-white">
          Prev
        </span>
