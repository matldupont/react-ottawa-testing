  ...
  return (
    <motion.div
      ...
      <motion.div variants={FADE_DOWN_ANIMATION_VARIANTS} className={classes}>
        <div className="mt-20">
          <h3 className="font-raleway text-6xl font-bold leading-tight">{SITE_NAME}</h3>
          <h3 className="font-raleway text-3xl font-medium">{SITE_DESCRIPTION} </h3>
        </div>
        <div className="flex-center flex flex-1 flex-col justify-center">
          <motion.div className="z-10 mt-6 flex items-center gap-x-5" variants={FADE_DOWN_ANIMATION_VARIANTS}>
            <a
      ...
      <div className="absolute right-32 top-20">
        <motion.div variants={FADE_UP_LG_ANIMATION_VARIANTS}>
          <div className="w-[225%] max-w-[225%] -rotate-12">
            <BranchColorMode>
              <img src="/icon-dark.svg" alt="TurboSlides by District Labs" className="h-auto w-full opacity-10" />
              <img src="/district.svg" alt="TurboSlides by District Labs" className="h-auto w-full opacity-40" />
            </BranchColorMode>
          </div>
        </motion.div>
      </div>
